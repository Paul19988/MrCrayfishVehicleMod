            ...
            matrices.pushPose();
            {
                ...
                for(int i = 0; i < 4; i++)
                {
                    matrices.pushPose();
                    {
                        ...
                        RenderObjectHelper.renderColoredModel(VehicleModels.VEHICLE_CRATE_SIDE.getBaseModel(), ItemTransforms.TransformType.NONE, false, matrices, buffers, -1, OverlayTexture.NO_OVERLAY, createSidedBlockLight(entity.getLevel(), entity.getBlockPos(), i));
                    }
                    matrices.popPose();
                }
                ...
                if(!entity.isOpened())
                {
                    matrices.pushPose();
                    {
                        ...
                        RenderObjectHelper.renderColoredModel(VehicleModels.VEHICLE_CRATE_TOP.getBaseModel(), ItemTransforms.TransformType.NONE, false, matrices, buffers, -1, OverlayTexture.NO_OVERLAY, LevelRenderer.getLightColor(entity.getLevel(), entity.getBlockPos().offset(0, 1, 0)));
                    }
                    matrices.popPose();
                }
                ...
                matrices.pushPose();
                {
                    ...
                    RenderObjectHelper.renderColoredModel(VehicleModels.VEHICLE_CRATE_SIDE.getBaseModel(), ItemTransforms.TransformType.NONE, false, matrices, buffers, -1, OverlayTexture.NO_OVERLAY, LevelRenderer.getLightColor(entity.getLevel(), entity.getBlockPos()));
                }
                matrices.popPose();
            }
            matrices.popPose();
